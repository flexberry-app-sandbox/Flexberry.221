...
namespace IIS.22
{
    ...
    public class ТЧЗаказ : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.22.Номенклатура fНоменклатура;
        
        private IIS.22.ОтчетОЗак fОтчетОЗак;
        ...
        [PropertyStorage(new string[] {
                "Номенклатура"})]
        [NotNull()]
        public virtual IIS.22.Номенклатура Номенклатура
        {
            get
            {
                ...
                IIS.22.Номенклатура result = this.fНоменклатура;
        ...
        /// <summary>
        /// мастеровая ссылка на шапку IIS.22.ОтчетОЗак.
        /// </summary>
        ...
        [TypeUsage(new string[] {
                "IIS.22.ЗаказПост",
                "IIS.22.ОтчетОЗак"})]
        public virtual IIS.22.ОтчетОЗак ОтчетОЗак
        {
            get
            {
                ...
                IIS.22.ОтчетОЗак result = this.fОтчетОЗак;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ТЧЗаказE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ТЧЗаказE", typeof(IIS.22.ТЧЗаказ));
                }
            }
        }
    }
    ...
    public class DetailArrayOfТЧЗаказ : ICSSoft.STORMNET.DetailArray
    {
        ...
        // *** Start programmer edit section *** (IIS.22.DetailArrayOfТЧЗаказ members)

        // *** End programmer edit section *** (IIS.22.DetailArrayOfТЧЗаказ members)
        ...
        /// </summary>
        public DetailArrayOfТЧЗаказ(IIS.22.ОтчетОЗак fОтчетОЗак) : 
                base(typeof(ТЧЗаказ), ((ICSSoft.STORMNET.DataObject)(fОтчетОЗак)))
        {
        }
        
        public IIS.22.ТЧЗаказ this[int index]
        {
            get
            {
                return ((IIS.22.ТЧЗаказ)(this.ItemByIndex(index)));
            }
        }
        
        public virtual void Add(IIS.22.ТЧЗаказ dataobject)
        {
