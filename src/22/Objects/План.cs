...
namespace IIS.22
{
    ...
    public class План : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.22.ПланЗакупок fПланЗакупок;
        ...
        /// <summary>
        /// мастеровая ссылка на шапку IIS.22.ПланЗакупок.
        /// </summary>
        ...
        [PropertyStorage(new string[] {
                "ПланЗакупок"})]
        public virtual IIS.22.ПланЗакупок ПланЗакупок
        {
            get
            {
                ...
                IIS.22.ПланЗакупок result = this.fПланЗакупок;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ПланE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ПланE", typeof(IIS.22.План));
                }
            }
        }
    }
    ...
    public class DetailArrayOfПлан : ICSSoft.STORMNET.DetailArray
    {
        ...
        // *** Start programmer edit section *** (IIS.22.DetailArrayOfПлан members)

        // *** End programmer edit section *** (IIS.22.DetailArrayOfПлан members)
        ...
        /// </summary>
        public DetailArrayOfПлан(IIS.22.ПланЗакупок fПланЗакупок) : 
                base(typeof(План), ((ICSSoft.STORMNET.DataObject)(fПланЗакупок)))
        {
        }
        
        public IIS.22.План this[int index]
        {
            get
            {
                return ((IIS.22.План)(this.ItemByIndex(index)));
            }
        }
        
        public virtual void Add(IIS.22.План dataobject)
        {
